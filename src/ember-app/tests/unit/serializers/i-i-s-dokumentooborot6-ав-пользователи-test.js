...
moduleForModel('i-i-s-dokumentooborot6-ав-пользователи', 'Unit | Serializer | i-i-s-dokumentooborot6-ав-пользователи', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot6-ав-пользователи',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
