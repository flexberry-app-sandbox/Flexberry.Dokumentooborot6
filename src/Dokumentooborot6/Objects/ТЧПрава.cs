...
namespace IIS.Dokumentooborot6
{
    ...
    public class ТЧПрава : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentooborot6.ПраваПол fПраваПол;
        ...
        public virtual IIS.Dokumentooborot6.ПраваПол ПраваПол
        {
            get
            {
                ...
                IIS.Dokumentooborot6.ПраваПол result = this.fПраваПол;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentooborot6.АвПользователи.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПраваE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПраваE", typeof(IIS.Dokumentooborot6.ТЧПрава));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПрава : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentooborot6.DetailArrayOfТЧПрава members)

        // *** End programmer edit section *** (IIS.Dokumentooborot6.DetailArrayOfТЧПрава members)
        ...
        /// </summary>
        public DetailArrayOfТЧПрава(IIS.Dokumentooborot6.АвПользователи fАвПользователи) : 
                base(typeof(ТЧПрава), ((ICSSoft.STORMNET.DataObject)(fАвПользователи)))
        {
        }
        
        public IIS.Dokumentooborot6.ТЧПрава this[int index]
        {
            get
            {
                return ((IIS.Dokumentooborot6.ТЧПрава)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentooborot6.ТЧПрава dataobject)
        {
