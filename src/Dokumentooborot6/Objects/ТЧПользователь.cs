...
namespace IIS.Dokumentooborot6
{
    ...
    public class ТЧПользователь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentooborot6.АвПользователи fАвПользователи;
        
        private IIS.Dokumentooborot6.ВходВСистему fВходВСистему;
        ...
        [PropertyStorage(new string[] {
                "АвПользователи"})]
        [NotNull()]
        public virtual IIS.Dokumentooborot6.АвПользователи АвПользователи
        {
            get
            {
                ...
                IIS.Dokumentooborot6.АвПользователи result = this.fАвПользователи;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentooborot6.ВходВСистему.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ВходВСистему"})]
        public virtual IIS.Dokumentooborot6.ВходВСистему ВходВСистему
        {
            get
            {
                ...
                IIS.Dokumentooborot6.ВходВСистему result = this.fВходВСистему;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПользовательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПользовательE", typeof(IIS.Dokumentooborot6.ТЧПользователь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПользователь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentooborot6.DetailArrayOfТЧПользователь members)

        // *** End programmer edit section *** (IIS.Dokumentooborot6.DetailArrayOfТЧПользователь members)
        ...
        /// </summary>
        public DetailArrayOfТЧПользователь(IIS.Dokumentooborot6.ВходВСистему fВходВСистему) : 
                base(typeof(ТЧПользователь), ((ICSSoft.STORMNET.DataObject)(fВходВСистему)))
        {
        }
        
        public IIS.Dokumentooborot6.ТЧПользователь this[int index]
        {
            get
            {
                return ((IIS.Dokumentooborot6.ТЧПользователь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentooborot6.ТЧПользователь dataobject)
        {
